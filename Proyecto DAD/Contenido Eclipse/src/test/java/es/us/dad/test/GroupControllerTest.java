...
public class GroupControllerTest {
	...
	public void testEAddDeviceToGroup(Vertx vertx, VertxTestContext testContext) throws InterruptedException {
		...
		Device device = new Device("Serial number 5", "Device number 5", "mqttChannelDevice5", 99999999L, 99999998L, 1);
					...
					if (messageHandler.succeeded()) {
						...
						for (int i = 0; i < 10; i++) {
							Device device = new Device(
									...
									"Device number group_" + lastInsertedValue.getIdGroup() + "_" + i, "mqttChannelDevice" + i, 0L,
									Calendar.getInstance().getTimeInMillis() + lastInsertedValue.getIdGroup(), lastInsertedValue.getIdGroup());
