...
/**
 * Lanzador encargado de iniciar todos los Verticles necesarios para
 * la ejecución del proyecto. Es necesario hacer los cambios en la
 * configuración de ejecución para que el Verticle predeterminado al
 * iniciar sea este: "run es.us.dad.Launcher"
 *
 */
